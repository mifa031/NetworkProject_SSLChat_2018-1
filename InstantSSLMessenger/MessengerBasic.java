...
public abstract class MessengerBasic {
	...
	protected abstract void recv(SocketChannel channel, SSLEngine engine) throws IOException;
	protected abstract void send(SocketChannel channel, SSLEngine engine, String message) throws IOException;
